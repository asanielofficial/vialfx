...
class LoadingWheel : public OpenGlQuad {
  public:
    ...
    virtual void render(OpenGlWrapper& open_gl, bool animate) override {
      ...
      static constexpr float kStartRads = -vial::kPi - 0.05f;
...
class SynthSection : public Component, public Slider::Listener,
  ...
  public:
    ...
    virtual void setAllValues(vial::control_map& controls);
    virtual void setValue(const std::string& name, vial::mono_float value, NotificationType notification);
