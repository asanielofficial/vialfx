...
class Tuning {
  public:
    static constexpr int kTuningSize = 2 * vial::kMidiSize;
    static constexpr int kTuningCenter = vial::kMidiSize;
    ...
    vial::mono_float convertMidiNote(int note) const;
  ...
  private:
    ...
    vial::mono_float tuning_[kTuningSize];
